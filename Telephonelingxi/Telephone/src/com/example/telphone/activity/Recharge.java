...
public class Recharge extends BaseActivity implements OnClickListener{
	...
	class ChargeTask extends AsyncTask<Integer, Integer, String>
	{
		...
		protected void onPostExecute(String result) 
		{
			...
			if(charge)
			{
				Toast.makeText(Recharge.this, "��ֵ�ɹ�", 5).show();
			}
			else
			{
				Toast.makeText(Recharge.this, "��ֵʧ��", 5).show();
			}
		}
		protected void onPreExecute() {  
			if(et_phone.getText()==null || et_card.getText()==null)
			{
				Toast.makeText(Recharge.this, "����д�ֻ��š�����", 8).show();
				
			}
			else
			{
				ready = true;
				dialog = ProgressDialog.show(Recharge.this, "��ֵ", "���ڳ�ֵ�����Ժ�...");
				dialog.show();
